...
const Congratulations = () => {
	...
	const directBooking = useSelector<RootState, any>(state => state.details.property.directBooking);
	...
	return (
		<Box paddingBottom={7}>
			...
			>
					...
					{isTransactionFailed ? (
						...
						<Box>
							<Typography
								...
								textAlign='center'
							>
								{ !directBooking ? 'Payment Successful !' : 'Booking Successful !'}
							</Typography>
							<Box display='flex' justifyContent='center' alignItems='center'>
								<img
									style={{
				...
				{directBooking ? (
					<SingleBooking breakPoint={breakPoint} setIsBookingSuccess={setIsBookingSuccess} onClickHome={onClickHome}/>
				) : (
					<TrackBooking   isTransactionFailed={isTransactionFailed} breakPoint={breakPoint} onClickHome={onClickHome} isBookingSuccess={isBookingSuccess} setIsBookingSuccess={setIsBookingSuccess} onClickTrack={onClickTrack}  />
				)}
			</Box>
		</Box>
	);
